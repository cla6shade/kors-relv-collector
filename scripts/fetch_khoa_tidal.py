"""Download KHOA tidal-station OpenAPI spec HWP and emit a timestamped Markdown.
...
SPEC_URL = "https://www.data.go.kr/data/15155508/openapi.do"
OUT_PREFIX = "docs/openapi_tidal_station"
...
def main() -> int:
    ...
    try:
        ...
        print(f"fetch_khoa_tidal failed: {e}", file=sys.stderr)
        return 1
